---
title: "SU_25_River_Rockfish_Proj_Fecundity_Ambient_VRevised"
...
# Amb Fec only scatterplot: atresia ids removed
pH_amb_fec_no_atresia_weight_adj_scatterplot <- ggplot(data = Amb_Fec_Samples) + 
...
pH_amb_fec_lm <- lm(pH ~ All_Fecundity, data = Amb_Fec_Samples)

pH_amb_fec_lm_res <- residuals(pH_amb_fec_lm)

summary(pH_amb_fec_lm)

pH_amb_fec_lm_res_plot <- simulateResiduals(fittedModel = pH_amb_fec_lm)
plot(pH_amb_fec_lm_res_plot)

pH_amb_fec_lm_cat <- lm(pH ~ Fecundity_Class)
...
ggsave(filename = "data-images/sodium_amb_fec_all_scatterplot.pdf", plot = sodium_amb_fec_all_scatterplot, device = "pdf")
ggsave(filename = "data-images/sodium_amb_fec_all_scatterplot.png", plot = sodium_amb_fec_all_scatterplot, device = "png")
...
ggsave(filename = "data-images/sodium_amb_fec_no_atresia_scatterplot.png", plot = sodium_amb_fec_no_atresia_scatterplot, device = "png")
...
ggsave(filename = "data-images/chloride_amb_fec_all_scatterplot.pdf", plot = chloride_amb_fec_all_scatterplot, device = "pdf")
ggsave(filename = "data-images/chloride_amb_fec_all_scatterplot.png", plot = chloride_amb_fec_all_scatterplot, device = "png")
...
ggsave(filename = "data-images/potassium_amb_fec_all_scatterplot.pdf", plot = potassium_amb_fec_all_scatterplot, device = "pdf")
ggsave(filename = "data-images/potassium_amb_fec_all_scatterplot.png", plot = potassium_amb_fec_all_scatterplot, device = "png")
...
# Amb_Fec Samples with Atresia Ids
potassium_amb_fec_all_boxplot <- ggplot(data = Amb_Fec_Samples) + 
...
print(potassium_amb_fec_all_boxplot)

ggsave(filename = "data-images/potassium_amb_fec_all_boxplot.pdf", plot = potassium_amb_fec_all_boxplot, device = "pdf")
ggsave(filename = "data-images/potassium_amb_fec_boxplot.png", plot = potassium_amb_fec_all_boxplot, device = "png")
