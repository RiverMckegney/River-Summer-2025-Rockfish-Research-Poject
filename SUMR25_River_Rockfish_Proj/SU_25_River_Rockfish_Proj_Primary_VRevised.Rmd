---
title: "SU_25_River_Rockfish_Proj_Primary_VRevised"
...
pH_primary_lm <- lm(pH ~ Ambient.Or.OAH, data = Primary_Samples)
summary(pH_primary_lm)

pH_primary_lm2 <- lm(pH ~ Ambient.Or.OAH * Pregnant.Or.Atresia, data = Primary_Samples)
summary(pH_primary_lm)

pH_primary_aov <- aov(pH ~ Ambient.Or.OAH * Pregnant.Or.Atresia, data = Primary_Samples)
summary(pH_primary_aov)

res <- residuals(pH_primary_lm)

pH_primary_simres_plot <- simulateResiduals(fittedModel = pH_primary_lm)
plot(pH_primary_simres_plot)

testOutliers(pH_primary_simres_plot)
...
chloride_primary_lmer3 <- lmer(Cl...mmol.L. ~ Pregnant.Or.Atresia * Ambient.Or.OAH + (1|Pregnant.Or.Atresia) + (1|Ambient.Or.OAH), data = Primary_Samples)
...
# Second best guess method:
potassium_primary_lmer2 <- lmer(K...mmol.L. ~ Pregnant.Or.Atresia * Ambient.Or.OAH + (1|Ambient.Or.OAH), data = Primary_Samples)
...
calcium_primary_lmer <- lm(Ca....mmol.L. ~ Ambient.Or.OAH * Pregnant.Or.Atresia + (1|Pregnant.Or.Atresia), data = Primary_Samples)
