---
title: "SU_25_River_Rockfish_Proj_Fecundity_V0.1"
...
pH Fecundity Count Scatterplot 
```{r}
# pH Scatterplot
...
pH Fecundity Class Scatterplot
```{r}
# pH Scatterplot
...
# New method
pH_fecund_lmer <- lmer(pH ~ Pregnant.Or.Atresia + Consensus_Fecundity + (1|Fecundity_Class), data = Fecundity_Count_Samples)
visualize(pH_fecund_lmer)
...
```{r}
# pH
# Fecundity ANOVA Test

# Two-Way Interactive ANOVA

# fecundity without atresia ids
...
# Fecundity data: without atresia ids
Fecundity_Samples %>%
...
# Fecundity Count data: with atresia ids
Fecundity_Count_Samples %>%
  group_by(Ambient.Or.OAH, Pregnant.Or.Atresia) %>%
  summarize(count = n(),
            median = round(median(Hct....), 3),
...
Hematocrit Fecundity Count Scatterplot 
```{r}
# hct Scatterplot

# Fecundity Samples
hct_fecundity_count_scatterplot <- ggplot(data = Fecundity_Count_Samples) + 
  geom_point(aes(x = Hct...., y = Consensus_Fecundity), colour = "black") +
...
print(hct_fecundity_count_scatterplot)

ggsave(filename = "data-images/hct_fecundity_count_scatterplot.pdf", plot = hct_fecundity_count_scatterplot, device = "pdf")
ggsave(filename = "data-images/hct_fecundity_count_scatterplot.png", plot = hct_fecundity_count_scatterplot, device = "png")

# Hct Fecundity Count facet scatterplot by Treatment
hct_fecundity_count_facet_scatterplot_treatment <- ggplot(data = Fecundity_Count_Samples) + 
  geom_point(aes(x = Hct...., y = Consensus_Fecundity), colour = "black") +
  labs(title = "Hematocrit Fecundity Count Samples", x = "Hct (%)", y = "Fecundity", ) +
  scale_y_continuous(breaks = c(0, 50000, 90000)) +
  facet_wrap(~ Ambient.Or.OAH) +
  theme_classic() +
  theme(panel.background = element_rect(fill = "white"),
...
print(hct_fecundity_count_facet_scatterplot_treatment)

# Hct fecundity count facet scatterplot by Fecundity Class
hct_fecundity_count_facet_scatterplot_fecundity_class <- ggplot(data = Fecundity_Count_Samples) + 
  geom_point(aes(x = Hct...., y = Consensus_Fecundity), colour = "black") +
  labs(title = "Hematocrit Fecundity Count Samples", x = "Hct....", y = "Brood Count") +
  scale_y_continuous(breaks = c(1000, 50000, 90000)) +
  facet_wrap(~ Fecundity_Class) +
...
Hematocrit Fecundity Class Scatterplot
```{r}
# hct Scatterplot

# Fecundity Samples
hct_fecundity_scatterplot <- ggplot(data = Fecundity_Samples) + 
  geom_point(aes(x = Hct...., y = Fecundity_Or_Brood_Count), colour = "black") +
...
print(hct_fecundity_scatterplot)

ggsave(filename = "data-images/hct_fecundity_scatterplot.pdf", plot = hct_fecundity_scatterplot, device = "pdf")
ggsave(filename = "data-images/hct_fecundity_scatterplot.png", plot = hct_fecundity_scatterplot, device = "png")

# Hct facet scatterplot by Treatment
hct_fecundity_facet_scatterplot_treatment <- ggplot(data = Fecundity_Samples) + 
  geom_point(aes(x = Hct...., y = Fecundity_Or_Brood_Count), colour = "black") +
  labs(title = "Hematocrit Fecundity Samples", x = "Hct (%)", y = "Brood Count") +
  scale_y_continuous(breaks = c(1000, 50000, 90000)) +
  facet_wrap(~ Ambient.Or.OAH) +
...
print(hct_fecundity_facet_scatterplot_treatment)

# Hct facet scatterplot by Fecundity Class
hct_fecundity_facet_scatterplot_fecundity_class <- ggplot(data = Fecundity_Samples) + 
  geom_point(aes(x = Hct...., y = Fecundity_Or_Brood_Count), colour = "black") +
  labs(title = "Hematocrit Fecundity Samples", x = "Hct....", y = "Brood Count") +
  scale_y_continuous(breaks = c(1000, 50000, 90000)) +
  facet_wrap(~ Fecundity_Class) +
...
print(hct_fecundity_facet_scatterplot_fecundity_class)
```
...
ggsave(filename = "data-images/hct_fecundity_facet_boxplot.png", plot = _fecundity_facet_boxplot, device = "png")
