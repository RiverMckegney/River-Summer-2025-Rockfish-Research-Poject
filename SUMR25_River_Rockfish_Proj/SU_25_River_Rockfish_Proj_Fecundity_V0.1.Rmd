...
pH_fecundity_scatterplot <- ggplot(data = Fecundity_Samples) + 
  geom_point(aes(x = Fecundity_Or_Brood_Count, y = pH), colour = "black") +
  labs(title = "pH", x = "Fecundity", y = "pH") +
  theme_classic() +
  theme(panel.background = element_rect(fill = "white"),
        plot.background = element_rect(fill = "white"),
        legend.background = element_rect(fill = "white", color = "black"),
...
# pH faceted scatterplot
pH_fecundity_facet_scatterplot <- ggplot(data = Fecundity_Samples) + 
  geom_point(aes(x = Fecundity_Or_Brood_Count, y = pH), colour = "black") +
  labs(title = "pH", x = "Fecundity", y = "pH") +
...
print(pH_fecundity_facet_scatterplot)
