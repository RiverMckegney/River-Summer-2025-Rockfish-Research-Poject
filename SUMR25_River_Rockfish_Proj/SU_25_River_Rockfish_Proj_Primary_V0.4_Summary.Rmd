...
pH_primary <- ggplot(data = Primary_Samples, aes(x = Pregnant.Or.Atresia, y = pH, fill = Ambient.Or.OAH)) +
  geom_boxplot(aes(x = Pregnant.Or.Atresia, y = pH, fill = Ambient.Or.OAH)) +
  geom_point(aes(color = Ambient.Or.OAH), position = position_dodge(width = 0.75), alpha = 0.3, color = "black") +
...
hct_primary <- ggplot(data = Primary_Samples, aes(x = Pregnant.Or.Atresia, y = Hct...., fill = Ambient.Or.OAH)) +
  geom_boxplot(aes(x = Pregnant.Or.Atresia, y = Hct...., fill = Ambient.Or.OAH)) +
  geom_point(aes(color = Ambient.Or.OAH), position = position_dodge(width = 0.75), alpha = 0.3, color = "black") +
  labs(title = "Hematocrit", x = "Parturition Type", y = "Hematocrit (%)") +
  guides(fill = guide_legend((title = "Treatment Type"))) + 
...
glu_primary <- ggplot(data = Primary_Samples, aes(x = Pregnant.Or.Atresia, y = Glu..mmol.L., fill = Ambient.Or.OAH)) +
  geom_boxplot(aes(x = Pregnant.Or.Atresia, y = Glu..mmol.L., fill = Ambient.Or.OAH)) +
  geom_point(aes(color = Ambient.Or.OAH), position = position_dodge(width = 0.75), alpha = 0.3, color = "black") +
  labs(title = "Glucose", x = "Parturition Type", y = "Glucose (mmol/L)") +
  guides(fill = guide_legend((title = "Treatment Type"))) + 
...
# pCO2 parturition groups
ggplot(data = Primary_Samples, aes(x = Pregnant.Or.Atresia, y = pCO2..mmHg.)) +
...
# pCO2 Treatment Groups
ggplot(data = Primary_Samples, aes(x = Ambient.Or.OAH, y = pCO2..mmHg.)) +
  geom_boxplot(aes(x = Ambient.Or.OAH, y = pCO2..mmHg., fill = Ambient.Or.OAH)) +
  geom_point(aes(color = Ambient.Or.OAH), position = position_dodge(width = 0.75), alpha = 0.3, color = "black") +
  labs(title = "Carbon Dioxide", x = "Treatment Type", y = "pCO2 (mmHg)") +
  scale_fill_manual(values = c("Ambient" = "#189bff", "OAH" = "#598c78")) +
...
# Basic plots
pCO2_primary_pregnancy <- ggplot(data = Primary_Samples, aes(x = Pregnant.Or.Atresia, y = pCO2..mmHg.)) +
  geom_boxplot() +
...
pCO2_primary_treatment <- ggplot(data = Primary_Samples, aes(x = Ambient.Or.OAH, y = pCO2..mmHg.)) +
  geom_boxplot() +
  geom_point(position = position_dodge(width = 0.75), alpha = 0.3, color = "black") +
  labs(title = "Carbon Dioxide", x = "Treatment Type", y = "pCO2 (mmHg)") +
  theme_classic() +
...
pCO2_primary_basic <- pCO2_primary_pregnancy + pCO2_primary_treatment + plot_layout(guides = "collect")
